...
if (!file_exists(__DIR__ . '/config.php')) {
    die('Error: config.php not found. Please copy config.sample.php and configure it.');
}
...
function isValidPhone($phone) {
    return strlen($phone) >= 10 && preg_match('/^[0-9\s\-\+]+$/', $phone);
}
...
function validateCheckoutForm($data) {
    ...
    $required_fields = ['firstName', 'lastName', 'email', 'phone', 'address', 'city', 'state', 'postalCode', 'country', 'shippingMethod'];
