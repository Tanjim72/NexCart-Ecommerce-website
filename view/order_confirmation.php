...
// Page-specific CSS files - Now consolidated in common.css
// $page_css = ['order-page.css'];
// Page-specific JS files - Now consolidated in utilities.js
// $page_js = ['order-page.js'];
